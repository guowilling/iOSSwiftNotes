...
extension RankViewModel {
    func loadRankDateData(_ type: RankType, _ complection: @escaping () -> ()) {
        ...
        let params = ["pageSize": 30, "type": type.typeNum]
        HTTPRequestTool.request(.get, URLString: URLString, parameters: params, completion: { result in
...
extension RankViewModel {
    func loadRankWeekData(_ rankType: RankType, _ completion: @escaping () -> ()) {
        ...
        let params: [String: Any] = ["imei": "36301BB0-8BBA-48B0-91F5-33F1517FA056",
                                     "pageSize": 30,
                                     "signature": signature,
                                     "ts": ts,
