...
let timeoutClosure = { (endpoint: Endpoint, closure: MoyaProvider<U17API>.RequestResultClosure) -> Void in
...
let APIProvider = MoyaProvider<U17API>(requestClosure: timeoutClosure)

let APILoadingProvider = MoyaProvider<U17API>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
